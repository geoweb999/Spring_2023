...
public abstract class Aircraft implements Comparable<Aircraft> {
	//M2 HOMEWORK IMPLEMENTED COMPARABLE
	//M2 HOMEWORK STATIC
	...
	public int compareTo(Aircraft obj)  {
		...
		if (this.registrationID.toUpperCase().compareTo(obj.registrationID.toUpperCase()) < 0)
			return -1;
		else if (this.registrationID.toUpperCase().compareTo(obj.registrationID.toUpperCase()) > 0)
			return 1;
		else {
			return 0;
		}
