...
public class Product {
	...
	public String toString() {
		return name + ", company=" + company 
				+ ", brand=" + brand + ", colorScentFlavor=" + colorScentFlavor
				+ ", category=" + category.getDescription() 
				+ ", number=" + getNumberOfChemicals();
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof Product) {
			...
			return otherProduct.name.equals(name) 
					&& otherProduct.company.equals(company)
					&& otherProduct.brand.equals(brand) 
					&& otherProduct.colorScentFlavor.equals(colorScentFlavor)
