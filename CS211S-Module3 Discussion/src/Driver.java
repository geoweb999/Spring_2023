...
public class Driver {
	public static void main(String[] args) {	
		...
		products[1] = new Electronic(2, "Laptop", 999.99, 5, "Dell Inspiron 15", "Dell", SaleType.PRESALE);
...
//		productF[1] = ProductFactory.newProduct("ELECTRONIC",2, "Laptop", 999.99, 5, "Dell Inspiron 15", "Dell", SaleType.TERMINATE);
